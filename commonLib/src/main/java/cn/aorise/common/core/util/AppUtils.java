...
//    }
     ...
     * @return String
     */
    public static String getAppMetaName(final String metaKey) {
        return getAppMetaName(Utils.getApp().getPackageName(), metaKey);
    }
     ...
     * @return String
     */
    public static String getAppMetaName(final String packageName, final String metaKey) {
        if (isSpace(packageName)) return null;
        try {
            PackageManager pm = Utils.getApp().getPackageManager();
            ApplicationInfo ai = pm.getApplicationInfo(packageName, PackageManager.GET_META_DATA);
            return ai == null ? null : ai.metaData.getString(metaKey);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static PackageInfo getPackageInfo() {
        return getPackageInfo(Utils.getApp().getPackageName());
    }
